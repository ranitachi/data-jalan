        ...
        <div class="dashboard-list-box fl-wrap">
            ...
            <div class="col-md-12 table-responsive" style="text-align:left;">
                ...
                <div class="profile-edit-container">
                        <form action="{{ route('all-sungai.update',$id) }}" method="post" id="simpan-sungai">
                            @csrf
                            @method('PATCH')
                            <div class="custom-form" style="padding-bottom:10px;">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select name="id_kecamatan" id="id_kecamatan" class="chosen-select" required="required">
                                            ...
                                            @foreach ($kecamatan as $item)
                                                @if ($item->id==$sungai->id_kecamatan)
                                                    <option value="{{ $item->id }}-{{$item->nama_kecamatan}}" selected="selected">{{ $item->nama_kecamatan }}</option>
                                                @else
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="nama_sungai" id="nama_sungai" required="required" value='{{$sungai->nama_sungai}}'>
                                    </div>
                                    <div class="col-md-2">
                                        <label>Luas Areal (Ha) <i class="fa fa-list"></i>  </label>
                                        <input type="text" name="areal" id="areal" required="required" value='{{$sungai->areal}}'>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="panjang_sungai_primer" id="panjang_sungai_primer" value='{{$sungai->panjang_sungai_primer}}'>
                                    </div>
                                    <div class="col-md-4">
                                        <label>Panjang Sungai Sekunder (m)  <i class="fa fa-list"></i></label>
                                        <input type="text" name="panjang_sungai_sekunder" id="panjang_sungai_sekunder" value='{{$sungai->panjang_sungai_sekunder}}'>
                                    </div>
                                    <div class="col-md-4">
                                        <label>Panjang Sungai Tersier (m)  <i class="fa fa-list"></i></label>
                                        <input type="text" name="panjang_sungai_tersier" id="panjang_sungai_tersier" value='{{$sungai->panjang_sungai_tersier}}'>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <label>Bangunan Pelengkap Box Tersier (Bh) <i class="fa fa-list"></i></label>
                                        <input type="text" name="bangunan_terlengkap_box_tersier" id="bangunan_terlengkap_box_tersier" value='{{$sungai->bangunan_terlengkap_box_tersier}}'>
                                    </div>
                                    <div class="col-md-4">
                                        <label>Bangunan Pelengkap Gorong-Gorong (Bh) <i class="fa fa-list"></i></label>
                                        <input type="text" name="bangunan_terlengkap_box_gorong" id="bangunan_terlengkap_box_gorong" value='{{$sungai->bangunan_terlengkap_box_gorong}}'>
                                    </div>
                                    <div class="col-md-4">
                                        <label>Bagunan Pelengkap Jembatan (Bh) <i class="fa fa-list"></i></label>
                                        <input type="text" name="bangunan_terlengkap_box_jembatan" id="bangunan_terlengkap_box_jembatan" value='{{$sungai->bangunan_terlengkap_box_jembatan}}'>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <label>Saluran Pasangan (m) <i class="fa fa-list"></i></label>
                                        <input type="text" name="saluran_bendung" id="saluran_bendung" value='{{$sungai->saluran_bendung}}'>
                                    </div>
                                    <div class="col-md-6">
                                        <label>Saluran Tanah (m) <i class="fa fa-list"></i></label>
                                        <input type="text" name="saluran_tanah" id="saluran_tanah" value='{{$sungai->saluran_tanah}}'>
                                    </div>
                                </div>
                                <legend>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" name="sudah_dibangun_bendung" id="sudah_dibangun_bendung" value='{{$sungai->sudah_dibangun_bendung}}'>
                                    </div>
                                    <div class="col-md-2">
                                        <label>Pintu Air  (Bh) <i class="fa fa-list"></i></label>
                                        <input type="text" name="sudah_dibangun_pintu_air" id="sudah_dibangun_pintu_air" value='{{$sungai->sudah_dibangun_pintu_air}}'>
                                    </div>
                                    <div class="col-md-2">
                                        <label>Bagi Sadap  <i class="fa fa-list"></i></label>
                                        <input type="text" name="sudah_dibangun_bagi_sadap" id="sudah_dibangun_bagi_sadap" value='{{$sungai->sudah_dibangun_bagi_sadap}}'>
                                    </div>
                                    <div class="col-md-2">
                                        <label>Box Tersier  (Bh) <i class="fa fa-list"></i></label>
                                        <input type="text" name="sudah_dibangun_box_tersier" id="sudah_dibangun_box_tersier" value='{{$sungai->sudah_dibangun_box_tersier}}'>
                                    </div>
                                    <div class="col-md-2">
                                        <label>Gorong-Gorong (Bh) <i class="fa fa-list"></i></label>
                                        <input type="text" name="sudah_dibangun_gorong" id="sudah_dibangun_gorong" value='{{$sungai->sudah_dibangun_gorong}}'>
                                    </div>
                                    <div class="col-md-2">
                                        <label>Jembatan (Bh) <i class="fa fa-list"></i></label>
                                        <input type="text" name="sudah_dibangun_jembatan" id="sudah_dibangun_jembatan" value='{{$sungai->sudah_dibangun_jembatan}}'>
                                    </div>
                                    <div class="col-md-2">
                                        <label>Saluran Pasangan (m) <i class="fa fa-list"></i></label>
                                        <input type="text" name="sudah_dibangun_pasangan" id="sudah_dibangun_pasangan" value='{{$sungai->sudah_dibangun_pasangan}}'>
                                    </div>
                                    <div class="col-md-2">
                                        <label>Saluran Tanah (m) <i class="fa fa-list"></i></label>
                                        <input type="text" name="sudah_dibangun_tanah" id="sudah_dibangun_tanah" value='{{$sungai->sudah_dibangun_tanah}}'>
                                    </div>
                                    <div class="col-md-2">
                                        <label>Sisa Pekerjaan (m) <i class="fa fa-list"></i></label>
                                        <input type="text" name="sisa" id="sisa" value='{{$sungai->sisa}}'>
                                    </div>
                                    <div class="col-md-2">
                                        ...
                                        <select name="jenis" id="jenis" class="chosen-select">
                                            ...
                                            <option value="pembuang" {{$sungai->jenis==
                                            'pembuang' ? 'selected="selected' : ''}}>Pembuang</option>
                                            <option value="sungai" {{$sungai->jenis==
                                            'sungai' ? 'selected="selected' : ''}}>Sungai</option>
                                            <option value="kali/drainase" {{$sungai->jenis==
                                            'kali/drainase' ? 'selected="selected' : ''}}>Kali / Drainase</option>
