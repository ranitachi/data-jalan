...
@section('content-head')
    ...
    <div class="profile-edit-page-header" style="margin-bottom:10px;">
        ...
        <div class="breadcrumbs">
            ...
            <span>Manajemen Data Verifikasi</span>
        </div>
    </div>
@endsection
        ...
        <div class="dashboard-list-box fl-wrap">
            <div class="dashboard-header fl-wrap">
                ...
                <div style="float:right;width:100px;">
                    <a href="{{ route('verifikasi.create') }}" class="btn btn-success btn-sm">+ Tambah Data</a>
                </div>
            </div>
                ...
                success: function(res) {
                    $('#user-table').dataTable({
                        ...
                        "columnDefs": [ {
                            ...
                            "targets"   : 7,
                            "render"    : function (item) {
                               return  "<a class='btn btn-xs btn-warning' href='{{ url('verifikasi') }}/"+item+"/edit'>" +
