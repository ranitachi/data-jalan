        ...
        <div class="dashboard-list-box fl-wrap">
            <div class="dashboard-header fl-wrap">
                ...
                <div style="float:right;width:100px;">
                    <a href="{{ route('all-situ.create') }}" class="btn btn-info btn-sm">+ Tambah Data</a>
                </div>
                <div style="float:right;width:100px;margin-right:20px;">
                    <a href="{{ url('download-file/situ') }}" class="btn btn-success btn-sm"><i class="fa fa-file-excel-o"></i> Download XLS</a>
                </div>
            </div>
