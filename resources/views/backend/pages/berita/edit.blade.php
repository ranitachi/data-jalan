...
@section('content-head')
    ...
    <div class="profile-edit-page-header" style="margin-bottom:10px;">
        ...
        <div class="breadcrumbs">
            ...
            <span>Form Edit Data Berita</span>
        </div>
    </div>
@endsection
            ...
            <div class="col-md-12" style="text-align:left;">
                <br>
                    <div class="profile-edit-container">
                        <form action="{{ url('api/berita-management/update') }}" method="POST" id="simpan-berita">
                            @csrf
                            @method('PATCH')
                            <div class="custom-form">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="file" id="thumbnail" readonly value="{{$berita->file}}">
                                    </div>
                                    <div class="col-md-1">
                                        <label>&nbsp;</label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="flag" id="flag" class="chosen-select">
                                            <option value="1" {{$berita->flag==1 ? 'selected="selected"' : ''}}>Aktif</option>
                                            <option value="0" {{$berita->flag==0 ? 'selected="selected"' : ''}}>Tidak Aktif</option>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <img id="holder" style="margin-top:15px;max-height:100px;" src="{{asset($berita->file)}}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <textarea type="text" name="desc" id="desc">{!!$berita->desc!!}</textarea>
                                    </div>
                                </div>
