...
function LoadMap_main(color) {
    ...
    if ($('#main-map').length) {
        ...
        var markers_map = new Array(
                [34.05843, -118.491046, 'assets/img/markers/'+prefix+'house.png', 'assets/img/placeholders/275x165.png', 'Restaurant'],
                [34.066673, -118.486562, 'assets/img/markers/'+prefix+'comercial.png', 'assets/img/placeholders/275x165.png', 'Swimming pool'],
                [34.009714, -118.480296, 'assets/img/markers/'+prefix+'house.png', 'assets/img/placeholders/275x165.png', 'Tropical villa'],
                [34.010408, -118.473215, 'assets/img/markers/'+prefix+'land.png', 'assets/img/placeholders/275x165.png', 'House'],
                [34.01521, -118.474889, 'assets/img/markers/'+prefix+'apartment.png', 'assets/img/placeholders/275x165.png', 'Modern room'],
                [34.022502, -118.480124, 'assets/img/markers/'+prefix+'house.png', 'assets/img/placeholders/275x165.png', 'Modern villa'],
                [34.024423, -118.459868, 'assets/img/markers/'+prefix+'land.png', 'assets/img/placeholders/275x165.png', 'Modern backyard'],
                [34.024885, -118.44871, 'assets/img/markers/'+prefix+'comercial.png', 'assets/img/placeholders/275x165.png', 'Modern lounge room'],
                [34.002368, -118.482828, 'assets/img/markers/'+prefix+'apartment.png', 'assets/img/placeholders/275x165.png', 'Hotel']
                );
